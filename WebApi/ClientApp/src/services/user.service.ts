...
async function login(username: string, password: string) {
  ...
  const response = await fetch(`${ApiUrl}/user/authenticate`, requestOptions);
...
async function loadFolders() {
  ...
  const response = await fetch(`${ApiUrl}/Folder`, requestOptions);
...
async function deleteFile(id: number, UpdateData: Function) {
  ...
  const response = await fetch(`${ApiUrl}/FileHolder/` + id, requestOptions);
...
async function deleteFolder(id: number, UpdateData: Function) {
  ...
  const response = await fetch(`${ApiUrl}/Folder/` + id, requestOptions);
  const folder = await handleResponse(response);
  UpdateData();
  return folder;
}
async function downloadFile(index: number) {
  ...
  const file = await axios.get(`${ApiUrl}/FileHolder/` + index, requestOptions);
